...
try: app_id = int(os.environ.get("app_id", "22520488"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "5ea80cc740bdb618b77ac2b748c1e6d5")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7117102377:AAH9KRco1KxqHfZNqwQbPU0QehyIVdNaXVU")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{extract by @berlinthejd 👑}`")
...
about_message = """
<b>• Name : <a href=https://t.me/berlinthejd>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/batmanthejd_Botz>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/batmanthejdbot>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/berlinthejd"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/batmanthejdbot?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/berlinthejd")
